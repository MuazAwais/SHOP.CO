...
import { getCart, clearCart } from "@/app/componenet/data/cartData";
  ...
  return (
    <div className="w-full max-w-md mx-auto border-2 rounded-xl p-8 bg-white mt-10">
      <form onSubmit={formik.handleSubmit}>
        ...
        <button
          type="submit"
          className="mt-6 w-full bg-gray-950 text-white py-3 rounded-full font-semibold hover:bg-gray-900 transition"
