    ...
    <div className='bg-black rounded-2xl pt-[32px] pl-[24px] pr-[23px] md:px-[64px]  pb-[28px] md:py-[36px] gap-y-[32px] flex flex-col md:flex-row justify-between items-center'>
        ...
        <div className='flex-col flex gap-[14px] max-w-[350px] w-full'>
            <div className='relative'>
                <input type="text" placeholder='Email your email address' className='text-[#02020277] bg-[#ffffff] py-[12px] pl-[48px] rounded-full w-full focus:ring focus:ring-black'/>
                <div className='absolute bottom-3  left-4'>
                    <CiMail size={24}/>
                </div>
            </div>
            <button className="bg-white font-black rounded-full px-[44px] py-[12px] hover:bg-gray-200 active:bg-white">
